...
\title{\todo{How's this title?}A Survey of Web Testing Frameworks and Workflow for Testing JavaScript Applications} %\vfill gives us the black space at the top of the page
...
\subsubsection{Chai.js \cite{Chaijs}}
...
\todo{These are terrible... I have no idea what to put in these tables for columns.}
\FloatBarrier
\begin{table}[h]
\resizebox{\textwidth}{!}{%
