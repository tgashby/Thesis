...
\title{\todo{How's this title?}A Workflow for Developers New to Web Application Testing} %\vfill gives us the black space at the top of the page
...
\todo{What to put in these tables for columns.}
\FloatBarrier
\begin{table}[ht]
\resizebox{\textwidth}{!}{%
...
\todo{Put the link in with some explanation text}
