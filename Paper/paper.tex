...
\numberofmembers{3} \chair{Michael Haungs, Ph.D.\newline Associate Professor of Computer Science} \othermemberA{Franz Kurfess, Ph.D.\newline Professor of Computer Science} \othermemberB{David Janzen, Ph.D.\newline Professor of Computer Science} \field{Computer Science} \campus{San Luis Obispo}
...
\begin{Figure}
  ...
  \captionof{figure}{ToDo app home page, simple three-button navigation} 
\end{Figure}
...
\begin{Figure}
  ...
  \captionof{figure}{Jenkins main screen}
\end{Figure}
...
\begin{Figure}
  ...
  \captionof{figure}{MagnumCI new project screen}
\end{Figure}
...
\begin{Figure}
  ...
  \captionof{figure}{MagnumCI build customization}
\end{Figure}
...
\begin{Figure}
  ...
  \captionof{figure}{MagnumCI example build}
\end{Figure}
...
To run Nightwatch, navigate to the project folder and run \lstinline{nightwatch -c} \newline \lstinline{path_to_nightwatch_config}. This will use the \lstinline{src_folders} attribute to determine where to look for the tests, start the Selenium server, and run the tests. When debugging certain functions of even test cases, tests can be isolated with the \lstinline{-t} flag: \lstinline{nightwatch -c nightwatch.json -t folder1/test1.js}. Nightwatch offers a number of other command-line arguments that are discussed in their developer guide \cite{NightwatchJS}.
...
\hline
                & Source LOC & Test LOC & Test LOC per Source LOC \\ \hline
Unit Tests      &          &       &                     \\ \hline
Model      & 93         & 104      & 1.11                    \\ \hline
Controller & 862        & 438      & 0.51                    \\ \hline
Server     & 321        & 206      & 0.64                    \\ \hline
UI Tests      &         &      &                     \\ \hline
Main          & N/A*       & 16       & N/A*                    \\ \hline
Event         & N/A*       & 140      & N/A*                    \\ \hline
Chapter       & N/A*       & 133      & N/A*                    \\ \hline
Story         & N/A*       & 102      & N/A*                    \\ \hline
Cleanup**    & N/A*       & 46       & N/A*                    \\ \hline
\end{tabular}
\captionof{table}{Lines of Code}
\end{table}
\FloatBarrier
...
\begin{tabular}{|l|l|l|}
\hline
          & Coverage & Elements Covered / Total Elements \\ \hline
Statement & 98.78\%  & 565 / 572                         \\ \hline
Branch    & 50\%*     & 4 / 8                             \\ \hline
Function  & 96\%     & 120 / 125                         \\ \hline
Line      & 98.77\%  & 564 / 571                                  \\ \hline
\end{tabular}
\captionof{table}{Code Coverage}
\end{table}
\FloatBarrier
...
UI Tests   &            & 29          \\ \hline
     ...
     & Cleanup    & 3           \\ \hline
\end{tabular}
\captionof{table}{Separate Tests}
\end{table}
...
\hline
           &                 & Asserts \\ \hline
Unit Tests &                 & 237     \\ \hline
           & Model      & 33      \\ \hline
           & Controller & 128     \\ \hline
           & Server     & 76      \\ \hline
UI Tests   &                 & 43      \\ \hline
           & Main         & 5       \\ \hline
           & Event        & 13      \\ \hline
...
\begin{tabular}{|l|l|l|}
\hline
                     & Mock Objects & Mock Functions \\ \hline
Controller Unit Test & 13           & 32              \\ \hline
Server Unit Test     & 4            & 11              \\ \hline
\end{tabular}
\captionof{table}{Mock Objects and Functions}
\end{table}
