...
The final decision came down to Mocha versus Intern. Mocha was eventually chosen over Intern because of the setup requirements and learning curve of Intern. Although Mocha requires a seperate assertion library, the setup and learning curve for one assertion library was much simpler than the setup and learning curve of all of the various ways to define and write tests in Intern. Perhaps with more time and patience we would have chosen Intern, but Mocha served our needs well and offered just enough flexibility to allow us comfort without giving us too many options.
