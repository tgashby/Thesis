...
Intern is a hybrid unit testing and browser testing framework that aims to be an all-in-one testing framework.
- BDD, TDD, Object Testing methods
...
- HAD TO EDIT APP.JS TO USE NEW JAR
- HAD TO ADD NEW JAR!
