...
Magnum is another online CI, it appears that Jenkins is one of the only ``off-line'' CI systems. Magnum has every feature you could want for free, however, it's still in public beta and although prices haven't been released, the team making Magnum CI has already stated that there will be price tiers. It is not unreasonable, though, to believe that Magnum CI will be free for open-source projects, and that's what we care about.
