...
We have found that this is not a solved problem by looking at some of the biggest web applications and websites around. A 2011 study showed that YouTube has at least eight errors, Apple has at least seven, Microsoft at least four, and the list goes on \cite{ErrorsInTheWild}. That may seem like a small amount for such large sites, but every error is an opportunity for malfunction and customer dissatisfaction.
